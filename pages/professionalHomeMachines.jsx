...
if (loading) return <Preloader />;
  ...
  const displayedMachines = phmachines.slice(startIndex, startIndex + pageSize);
  ...
  return (
    <>
      ...
      <section className="section kf-started-inner">
       ...
       {/* Section Quote */}
       <div className="kf-titles align-center" style={{marginTop:"4rem", display: "grid",
    placeItems: "center",}}>
            <div
            ...
            <h3
              ...
              data-animate="active" style={{ width:"90%", textAlign:"center"}}
            >
             Explore Our High-Performance Machines Today!
            </h3>
          </div>
      {/* Section Archive */}
      <section className="section kf-archive" style={{ marginTop: "-1rem",width:"100%"}} >
...
>
            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-8" style={{margin:"auto", minWidth:"105%"}} >
              ...
              {displayedMachines.map((machine, index) => (
                ...
                >
                  <div className="image kf-image-hover">
                      ...
                      <img src={machine.image_url} alt="image" style={{
      width: '100%',
      height: 'auto',
      objectFit: 'contain',
      display: 'block'
                    ...
                    <div className="kf-text">
                     {machine.description}
                        ...
                        <ul className="additional-info">
                          {Object.entries(machine.additional_info).map(([key, value], i) => (
