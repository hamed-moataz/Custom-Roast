...
import AddGrinder from '@/admin/sub-components/grinders/AddGrinder';
import CoffeeGrindersPage from '@/admin/sub-components/grinders/ShowGrinders';
    ...
    <Container  className="p-6" style={{backgroundColor:theme.blue}} >
      ...
      <div className="py-6"   >
       ...
       <Col style={{margin:"auto"}}  xl={9}>
          {/* About Me */}
          <AddGrinder onInsert={handleGrinderInsert} />
          </Col>
