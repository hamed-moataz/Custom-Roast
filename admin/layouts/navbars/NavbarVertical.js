...
// import routes file
import DashboardMenu from "@/admin/routes/DashboardRoutes";
...
const NavbarVertical = (props) => {
  ...
  const CustomToggle = ({ children, eventKey, icon }) => {
    ...
    return (
      <li className="nav-item"  style={{color:"#f6f6f6"}}>
        <Link
          href="#"
          className="nav-link "
          style={{color:"#f6f6f6"}}
      ...
      <SimpleBar style={{ maxHeight: "100vh" }}>
        <div className="nav-scroller">
          <Link href="#" className="navbar-brand"  >
            <Image src="/images/logo3.png" alt=""  style={{height:"70px", margin:"auto", textAlign:"center"}}/>
            <br/>
            ...
            if (menu.grouptitle) {
              return (
                <Card bsPrefix="nav-item" key={index}>
                  {/* group title item */}
                  <div className="navbar-heading" style={{ color: theme.white }}>{menu.title}</div>
